...
docker run -it -v $(pwd):$(pwd) -w $(pwd) -e AWS_ACCESS_KEY_ID -e AWS_REGION -e AWS_SECRET_ACCESS_KEY rastasheep/ubuntu-sshd:16.04 ./lastkeypair_linux_amd64 ssh exec -- -o StrictHostKeyChecking=no -p 2222 travis@$CONTAINER_IP | tee out.log
